...
public class Flags {
    ...
    public static final byte flag_heart = (byte) (Integer.parseInt("83", 16));
    public static final byte flag_half = (byte) (Integer.parseInt("84", 16));
    public static final byte flag_progress = (byte) (Integer.parseInt("85", 16));
    public static final byte flag_enviar_error = (byte) (Integer.parseInt("86", 16));
